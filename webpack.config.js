...
const ASSETS_LIMIT = typeof process.env.ASSETS_LIMIT !== 'undefined' ? parseInt(process.env.ASSETS_LIMIT, 10) : 9000// limit bellow the assets will be inlines
...
const config = {
  ...
  module: {
    ...
    loaders: [
      ...
      { test: /\.(gif|jpg|png)$/, loader: 'url?limit=' + ASSETS_LIMIT + '&name=assets/[hash].[ext]' },
